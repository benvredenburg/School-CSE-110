    ...
    if choice_2 == 'Search':
        ...
        if choice_3 == 'Enter':
            ...
            if choice_4 == 'Attack':
                ...
                print('The Marilith deftly slips from your grasp and slithers up and out of the\ntrap door. A loud *thud* shortly follows as the door is blocked from the\nother side.')
                # Break line for readability
                print()
                print('---------------------------------------------------------------------------')
                print()
            ...
            print('---------------------------------------------------------------------------')
            print()
            choice_2 = input('As you return to the entrance, you are left with 2 choices: OPEN the door\nor EXAMINE the runes.\n\nYour Choice: ').capitalize()
            # Break line for readability
            print()
            print('---------------------------------------------------------------------------')
            print()
    ...
    if choice_2 == 'Open':
        ...
        if choice_3 == 'Strike':
            ...
            if choice_4 == 'Escape':
                ...
                print('The man standing above you looks down in disgust. "Puny man," he mocks,\n"why have you--"\n\nHe is cut off mid-sentence as the tail of the Marilith wraps around his neck')
                # Break line for readability
                print()
                print('---------------------------------------------------------------------------')
                print()
                choice_5 = input('Do you wish to RUN away or FINISH your mission?\n\nYour Choice: ').capitalize()
                print()
                print('---------------------------------------------------------------------------')
                print()
                if choice_5 == 'Run':
                    ...
                    print('---------------------------------------------------------------------------')
                    print()
                    print('You flee the cave not even daring to look back. You hear the Marilith\ntaunting you from within the cave.')
                    print()
                    print('---------------------------------------------------------------------------')
                    ...
                    print('---------------------------------------------------------------------------')
                    print()
                    print('You grab your sword through the agony in your arm and sweep around behind the Marilith, plunging your sword through her heart. The man is dead from the attack but at least you still accomplished your objective.')
                    # Break line for readability
                    print()
                    print('---------------------------------------------------------------------------')
                    print('CONGRATULATIONS! You have slain the monster terrorizing the nearby village.')
            ...
            if choice_4 == 'Fight':
                ...
                print('---------------------------------------------------------------------------')
                print()
                print('You flee the cave not even daring to look back. You hear the man\ntaunting you from within the cave.')
                print()
                print('---------------------------------------------------------------------------')
                print('CONGRATULATIONS! You escaped with your life.')
                print('---------------------------------------------------------------------------')
